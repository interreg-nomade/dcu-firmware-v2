...
void ssd1306_GetDiff(uint8_t* buf1, uint8_t* buf2, uint8_t* diff);
...
/** Calibration text **/
void dcu_set_text_cal_gyro();
void dcu_set_text_cal_accel();
void dcu_set_text_cal_mag();
