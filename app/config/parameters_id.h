...
#define SETUP_PRM_DATA_OUTPUT_DATATYPE_IMUQUAT_100HZ          0x43370000 // 183 IMU_QUAT_100Hz (Quat only - 6DOF) (0xB7)
#define SETUP_PRM_DATA_OUTPUT_DATATYPE_IMUQUAT_9DOF           0x43380000 // 184 IMU_QUAT_9DOF (Quat only) (0xB8)
#define SETUP_PRM_DATA_OUTPUT_DATATYPE_IMUQUAT_9DOF_100HZ     0x43390000 // 185 IMU_QUAT_9DOF_100Hz (Quat only) (0xB9)
#define SETUP_PRM_DATA_OUTPUT_DATATYPE_IMUGYRO_ACC_MAG        0x433A0000 // 186 IMU_GYRO_ACC_MAG (RAW) (0xBA)
#define SETUP_PRM_DATA_OUTPUT_DATATYPE_IMUGYRO_ACC_MAG_100HZ  0x433B0000 // 187 IMU_GYRO_ACC_MAG_100Hz (0xBB)
