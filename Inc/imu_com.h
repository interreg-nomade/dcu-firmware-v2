...
#define DATA_FORMAT_1                                                   0x01	//  QUAT
#define DATA_FORMAT_2                                                   0x02	//  GYRO
#define DATA_FORMAT_3                                                   0x03	//  ACC
#define DATA_FORMAT_4                                                   0x04	//  GYRO + ACC
#define DATA_FORMAT_5                                                   0x05	//  QUAT + GYRO + ACC
...
#define IMU_SENSOR_MODULE_REQ_SAMPLING_FREQ_CHANGE                      0x80
