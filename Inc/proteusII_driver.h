...
#define CMD_RESET_REQ           0x00    //  7.5.2  Reset the module
#define CMD_GETSTATE_REQ        0x01    //  7.5.1  Request the current module state
#define CMD_SLEEP_REQ           0x02    //  7.5.3  Go to sleep
#define CMD_DATA_REQ            0x04    //  7.3.1  Send data to the connected device
#define CMD_CONNECT_REQ         0x06    //  7.2.1  Setup a connection with another device
#define CMD_DISCONNECT_REQ      0x07    //  7.2.5  Close the connection
#define CMD_SCANSTART_REQ       0x09    //  7.1.1  Start scan
#define CMD_SCANSTOP_REQ        0x0A    //  7.1.2  Stop scan
#define CMD_GETDEVICES_REQ      0x0B    //  7.1.3  Request the scanned/detected devices
#define CMD_SETBEACON_REQ       0x0C    //  7.3.4  Place data in scan response packet
#define CMD_PASSKEY_REQ         0x0D    //  7.2.9  Respond to a pass key request
#define CMD_DELETEBONDS_REQ     0x0E    //  7.2.12 Delete bonding information
#define CMD_GETBONDS_REQ        0x0F    //  7.2.11 Read the MACs of bonded devices
#define CMD_GET_REQ             0x10    //  7.4.2  Read the module settings in flash
#define CMD_SET_REQ             0x11    //  7.4.1  Modify the module settings in flash
#define CMD_PHYUPDATE_REQ       0x1A    //  7.2.7  Update the PHY
#define CMD_UARTDISABLE_REQ     0x1B    //  7.5.6  Disable the UART
#define CMD_FACTORYRESET_REQ    0x1C    //  7.5.5  Perform a factory reset
#define CMD_DTMSTART_REQ        0x1D    //  7.6.1  Enable the direct test mode
#define CMD_DTM_REQ             0x1E    //  7.6.2  Start/stop a test of the direct test mode
#define CMD_BOOTLOADER_REQ      0x1F    //  7.5.8  Switch to the bootloader
